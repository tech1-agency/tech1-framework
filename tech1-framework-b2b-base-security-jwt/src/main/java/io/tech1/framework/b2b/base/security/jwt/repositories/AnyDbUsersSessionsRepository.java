...
public interface AnyDbUsersSessionsRepository {
    ...
    void deleteByUsernameExceptSessionIdEqualsRefreshToken(Username username, CookieRefreshToken cookie);
    void deleteExceptSessionIdEqualsRefreshToken(CookieRefreshToken cookie);
}
