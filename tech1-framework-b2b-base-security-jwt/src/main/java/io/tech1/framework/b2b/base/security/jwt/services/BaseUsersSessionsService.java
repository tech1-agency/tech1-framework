...
public interface BaseUsersSessionsService {
    ...
    void refresh(JwtUser user, AnyDbUserSession oldSession, JwtAccessToken newAccessToken, JwtRefreshToken newRefreshToken, HttpServletRequest httpServletRequest);
