...
import static io.tech1.framework.foundation.utilities.random.RandomUtility.randomChronoUnit;
...
public class TimeAmount extends AbstractPropertyConfigs {
    ...
    public io.tech1.framework.foundation.domain.time.TimeAmount getTimeAmount() {
        return new io.tech1.framework.foundation.domain.time.TimeAmount(
                this.amount,
                this.unit
        );
    }
